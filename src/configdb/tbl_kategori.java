...
public class tbl_kategori {
    ...
    public String VAR_namakategori = null;
    ...
    public void SimpanAnggota(Integer ID, String namakategori){
        try {
            // gunakan nama tabel yang benar
            String sql = "INSERT INTO tbl_kategori(id_kategori, nama_kategori) "
                       + "VALUES('"+ID+"', '"+namakategori+"')";

            // cek apakah id sudah ada
            String cekPrimary = "SELECT * FROM tbl_kategori WHERE id_kategori = '"+ID+"'";
            ...
            if (data.next()) {
                ...
                this.VAR_namakategori = data.getString("namakategori");
                this.validasi = true;
            } else {
                this.validasi = false;
    ...
    public void ubahAnggota(Integer ID, String namakategori){
        try {
            // nama tabel dan kolom disesuaikan
            String sql = "UPDATE tbl_kategori SET nama_kategori=? WHERE id_kategori=?";
    ...
    public void hapusAnggota01(Integer ID){
        try {
            ...
            String sql = "DELETE FROM tbl_kategori WHERE id_kategori='"+ID+"'";
            Statement perintah = koneksi.createStatement();
    ...
    public ResultSet getDataKategori() {
    ResultSet rs = null;
    try {
        ...
        public void tampilDataAgenda(JTable komponenTable, String SQL){
            try {
              ...
              modelTable.addColumn("nama_kategori");
